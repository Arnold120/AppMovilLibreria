...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        AutoRoute(
          page: RouteInicioSesion.page,
          path: PantallaInicioSesion.nombreRuta,
        ),
        AutoRoute(
          page: RouteRegistro.page,
          path: PantallaRegistro.nombreRuta,
        ),
        AutoRoute(
          ...
          children: [
            AutoRoute(
              page: RouteTablero.page,
              path: PantallaTablero.nombreRuta,
              initial: true,
            ),
            AutoRoute(
              page: RoutePerfil.page,
              path: PantallaPerfil.nombreRuta,
            ),

            AutoRoute(
              page: RouteMarca.page,
              path: PantallaMarca.nombreRuta,
            ),
          ],
        ),
      ];
