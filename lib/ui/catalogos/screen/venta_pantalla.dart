...
class _PantallaVentaState extends State<PantallaVenta> with SingleTickerProviderStateMixin {
  ...
  int _selectedIndex = 1; // Índice para Ventas en el BottomNavigationBar
  ...
  void _onItemTapped(int index) {
    // Solo navegar si es una pantalla diferente
    if (index != _selectedIndex) {
      switch (index) {
        case 0: // Inicio
          context.router.replace(const RoutePrincipal());
          break;
        case 1: // Ventas (actual) - no hacer nada
          break;
        case 2: // Compras
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          // QUITADO: El leading que navegaba al panel principal
          ...
          Autocomplete<Cliente>(
            ...
            onSelected: (cli) {
              setState(() {
                ...
                controller.setCliente(cli.cliente_ID);
              });
            },
          ),
          gap(12),
